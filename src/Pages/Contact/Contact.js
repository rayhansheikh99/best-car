            ...
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <form className="p-6 flex flex-col justify-center">
                        ...
                        <div className="flex flex-col mt-2">
                            <label for="tel" className="hidden">Message</label>
                            <textarea type="tel" name="tel" id="tel" placeholder="Write your message here" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"/>
                        </div>
